...
terraform {
    backend "s3" {
<<<<<<< HEAD:config-rules-terraform/secondary_account/backend.tf
...
=======
        ...
        region         = "us-east-1"
        dynamodb_table = "config-terraform"
>>>>>>> 5cd8889a595d99bb7d0bd21bf2ab920c68b3cc4a:multi-region-org-config-rules-terraform-master/administrator_account/backend.tf
    }
}
